-- Водить.РФ — база данных vodit_rf
SET NAMES utf8mb4;

CREATE DATABASE IF NOT EXISTS `vodit_rf` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `vodit_rf`;
...
('test12', '$2y$12$di3Sp90YCZywBqYGbqnMbOgPN1yCj243u.vSZdvdfraA2NRFzbsyC', 'Наумова Софья Михайловна', '79998567744', 'test1@mail.ru', '1998-05-12');
